...
class pysonggui(Frame):
    def __init__(self,Master=None,*pos,**kw):
        ...
        self._Checkbutton1 = Checkbutton(self._Frame25, variable = self._CheckVar1, state=DISABLED)
        ...
        self._Radiobutton2 = Radiobutton(self._Frame55, text="Google",
                        variable=self._RadioVar1, value=2,command=self._on_RadioButton2_selection)
    ...
    def _on_RadioButton1_selection(self, Event=None):
        self._Checkbutton1.config(state=DISABLED)
